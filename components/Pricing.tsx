    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {plans.map((plan, index) => (
          <Card 
            key={index} 
            className={`shadow-lg $plan.popular 
          ...
          >
            ...
            <CardHeader>
              <div className="flex justify-between items-start">
                ...
                <div className={`p-2 rounded-full $plan.popular ? 'bg-purple-100' : 'bg-gray-100'`}>
                  <plan.icon className={`h-5 w-5 $plan.popular ? 'text-purple-600' : 'text-gray-600'`} />
                </div>
              </div>
            </CardHeader>
            <CardContent>
